...
class BacalyzeApp(wx.Frame):
    def __init__(self, *args, **kw):
        frame_style = wx.DEFAULT_FRAME_STYLE# & ~(wx.RESIZE_BORDER | wx.MAXIMIZE_BOX)
        super(BacalyzeApp, self).__init__(*args, **kw, style=frame_style)
    ...
    def run_pipeline(self):
        ...
        output_directory = f"{self.doc}/Bacalyze/main/output/{self.current_date_time}"
        custom_directory = f"{self.doc}/Bacalyze/main/custom/"
        ...
        command_run = (
            ...
            f" --outdir /workspace/output/{self.current_date_time}"
